...
ori_context = "Read the abstract of the research paper provided below. " \
    + "Please paraphrase the abstract into a single paragraph, maintaining a formal and academic tone. " \
